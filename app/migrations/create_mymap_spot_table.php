...
class Migration {
    ...
    public function addd()
    {
        ...
        */
        $this->conexion::schema()->create('spot', function ($table) {
            $table->integer('id_spot')->primary();
            $table->string('nombre', 90);
            $table->string('descripcion', 150);
            $table->integer('id_image');
            
            $table->foreign('id_image', 'spot')->references('id_image')->on('images')->onDelete('cascade')->onUpdate('cascade');
        });
    }
}
